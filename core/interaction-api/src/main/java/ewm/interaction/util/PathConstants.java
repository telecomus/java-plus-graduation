...
public class PathConstants {
    ...
    public static final String PRIVATE_REQUEST_CANCEL =  REQUEST_ID + CANCEL; // Отмена конкретного запроса
    ...
    public static final String USER_ID_EVENT_ID =  EVENT_ID+ USER_ID;
}